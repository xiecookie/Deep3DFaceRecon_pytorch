...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--init_path', type=str, default='checkpoint/init_model/resnet50-0676ba61.pth')
        ...
        if is_train:
            ...
            parser.add_argument('--net_recog_path', type=str, default='checkpoint/recog_model/ms1mv3_arcface_r50_fp16/backbone.pth')
